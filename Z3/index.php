...
try {
  ...
  $stmt = $db->prepare("INSERT INTO clientinfo (username, user_email, years, gender, userl, superpower, bio) SET 'username' = :username, 'user_email' = :user_email, 'years' = :years, 'gender' = :gender, 'userl' = :userl, 'superpower' = :superpower, 'bio' = :bio");
  $stmt->execute(array('username' => $username, 'user_email' => $user_email, 'years' => $years, 'gender' => $gender, 'userl' => $userl, 'superpower' => $superpower, 'bio' => $bio));
